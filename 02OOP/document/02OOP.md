...
​		面向对象就是把现实世界的具体事物全部看成一个一个的对象来解决实际问题

​		面向对象不是一种技术, 而是一种编程指导思想
...
​		如果程序也能够按照生活的中的方式来解决问题,那么程序就更符合人类的思维习惯，

​		所以面向对象编程就是把现实世界的具体事物全部看成一个一个的对象来解决问题

​		这样，程序代码符合人类思维习惯，更易理解、更简单、更易维护

## 3）类与对象

​			对象就是真实存在的具体实例

​			类就是是对象共同特征的抽象描述,也就是一类具有共同属性和行为的事物的抽象
...
​				而且public修饰的类名必须成为代码文件名, 实际开发中建议一个文件定义一个class类
