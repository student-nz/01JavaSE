...
​				![image-20221009124232997](D:\yjxz\Review_outline\yjxz\background\document\assets\IDEA项目结构.png)
...
![image-20221009125037999](D:\yjxz\Review_outline\yjxz\background\document\assets\字面量类型.png)
...
![image-20221009170524484](D:\yjxz\Review_outline\yjxz\background\document\assets\常量.png)
...
![image-20221009170858707](D:\yjxz\Review_outline\yjxz\background\document\assets\数据类型.png)
...
![image-20221009170930935](D:\yjxz\Review_outline\yjxz\background\document\assets\基础数据类型分类.png)
...
​		![image-20221009125649179](D:\yjxz\Review_outline\yjxz\background\document\assets\ASCII.png)
...
​				![image-20221009132113723](D:\yjxz\Review_outline\yjxz\background\document\assets\运算符优先级.png)
...
​	![image-20221009132438938](D:\yjxz\Review_outline\yjxz\background\document\assets\if格式.png)
...
![image-20221009132513365](D:\yjxz\Review_outline\yjxz\background\document\assets\switch.png)
...
​			![image-20221009132742020](D:\yjxz\Review_outline\yjxz\background\document\assets\for循环.png)

### 		while

​				![image-20221009132828683](D:\yjxz\Review_outline\yjxz\background\document\assets\while循环.png)

### 		do-while

​				do-while循环即先执行一次再判断循环条件

​				![image-20221009133009638](D:\yjxz\Review_outline\yjxz\background\document\assets\do-while.png)

### 死循环

​	无限循环即如果没有其它条件干预循环，循环就不会停止下来

​	![image-20221009133121591](D:\yjxz\Review_outline\yjxz\background\document\assets\死循环.png)

### 循环嵌套

​	循环嵌套即循环中又包含循环

​	![image-20221009133159662](D:\yjxz\Review_outline\yjxz\background\document\assets\循环嵌套.png)
...
​	![image-20221009133757602](D:\yjxz\Review_outline\yjxz\background\document\assets\跳转整个外部循环.png)

​	continue可以用在嵌套循环中跳出外部循环的当次执行进入外部循环的下一次

​    ​![image-20221009133822699](D:\yjxz\Review_outline\yjxz\background\document\assets\继续外部循环.png) 
...
​				   ![image-20221009173454142](D:\yjxz\Review_outline\yjxz\background\document\assets\二维数组.png)	
...
​					![image-20221009135632513](D:\yjxz\Review_outline\yjxz\background\document\assets\方法.png)  
